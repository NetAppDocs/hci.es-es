...
* Actualice al plugin de Element para vCenter Server 5.0 o 5.1.
...
** La página de registro del plugin de vCenter para el plugin de Element para vCenter Server 4.x:
+
