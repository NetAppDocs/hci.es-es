...
NOTE: El software Element 12.9 es la última versión e incluye actualizaciones de seguridad y componentes del sistema, mejoras operativas y problemas resueltos. https://docs.netapp.com/us-en/element-software/concepts/concept_rn_whats_new_element.html["Obtén más información sobre las novedades de Element 12.9"^] .
